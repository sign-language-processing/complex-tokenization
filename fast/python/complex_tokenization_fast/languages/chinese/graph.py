...
from complex_tokenization_fast._rs import Tree, utf8
from complex_tokenization_fast.languages.chinese.ideographic_description_sequences import (
    IDSNode,
...
@cache
def chinese_character_to_graph(cluster: str):
